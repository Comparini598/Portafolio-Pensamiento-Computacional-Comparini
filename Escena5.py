...
# Dibujar árboles
num_trees = 12
tree_spacing = 65  # Espacio entre árboles
...
def dibujar_triangulo(base, altura, x, y):
    t.penup()
    t.goto(x, y)
    t.pendown()
    t.begin_fill()
...
dibujar_circulo(60, 156, -171)

# Dibujar la cabeza del gato (círculo)
dibujar_circulo(40, 144, -71)

# Dibujar los ojos del gato (círculos)
t.color("white")
dibujar_circulo(5, 110, -48)
dibujar_circulo(5, 125, -48)

# Dibujar los ojos por dentro del gato (círculos)
t.color("black")
dibujar_circulo(4, 112, -48)
dibujar_circulo(4, 127, -48)

# Dibujar la nariz
t.color("pink")
dibujar_circulo(3, 120, -61)


# Dibujar la boca del gato (sonrisa)
t.penup()
t.goto(100, -68)
t.setheading(-60)
t.pendown()
...
# Dibujar las orejas del gato (triángulos)
t.color("orange")
dibujar_triangulo( 30, 30, 80, -23)
dibujar_triangulo(30, 30, 110, -23)

# Dibujar las patas delanteras del gato (círculos)
dibujar_circulo(15, 170, -105)
dibujar_circulo(15, 78, -100)

# Dibujar las patas traseras del gato (círculos)
dibujar_circulo(15, 154, -200)
dibujar_circulo(15, 84, -200)

# Dibujar una pelota:)
t.penup()
t.goto(208, -95)  # Esquina inferior derecha
t.penup()
t.color("red")  # Color café claro
t.begin_fill()
t.color("red") #cafe claro
t.circle(35)
t.end_fill()

# Dibujar una cola:)
t.color("orange")
dibujar_circulo(10, 50, -155)
...
stories = [
    ("¡Si había alguien, era su viejo amigo Fatcat! Luego de saludarse y recordar los viejos tiempos, decidieron salir al bosque a jugar pelota- Fin", draw_tree()),
    
]


# Esconder la pluma y terminar
t.hideturtle()
turtle.done()